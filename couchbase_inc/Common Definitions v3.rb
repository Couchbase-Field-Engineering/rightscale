name 'Common Definitions v3'
rs_ca_ver 20161221
package "package/se_common_v3"
...
parameter "version" do
  ...
  allowed_values "4.1.0", "4.1.1", "4.5.0", "4.5.1", "4.6.0", "4.6.1", "4.6.2", "4.6.3","4.6.4","4.6.5","5.0.1","5.1.1","5.5.1","5.5.2","5.5.3","6.0.0","6.0.1","6.0.2","6.0.3", "6.5.0", "6.5.1", "6.6.0", "6.6.1", "7.0.3", "7.1.0"
  default "7.1.0"
  description "7.1 Now Available!"
end
