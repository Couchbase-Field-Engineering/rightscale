name 'Couchbase Day 6.5'
rs_ca_ver 20160622
import "package/common"

short_description 'Couchbase Day Sandbox: 1 6.5.0 Couchbase Server & 1 Application Server'
...
resource 'all_services_node', type: 'server' do
    like @common.cb_node
    name 'Couchbase Server 6.5 - Data/Query/Index/FTS'
    inputs do {
...
define generated_launch(@eip,@all_services_node,@app_node, $cluster_port,$shutdown)  return $cluster_ip, $cluster_dns, $app_node_ip, $app_node_dns  do
    $inp = {
        ...
        'CB_URL':'text:https://s3.amazonaws.com/packages.couchbase.com/releases/6.5.0/couchbase-server-enterprise-6.5.0-centos7.x86_64.rpm',
        'LCB_VER':'text:2.5.1',
